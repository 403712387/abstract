...
LIBS += -L../../bin/abstract/lib/module -lCommon -lCoreModule -lHttpModule -lServiceStatusModule -lConfigureModule -lChooseBestModule \
        -lFFmpegIngestModule -lTrackPersonModule -lTrackFaceModule -lAbstractModule \
...
LIBS += -L../../bin/abstract/lib/module -lCommon -lCoreModule -lHttpModule -lServiceStatusModule -lConfigureModule -lChooseBestModule \
        ...
        -lopencv_flann -lopencv_gapi -lopencv_dnn -lopencv_photo -lopencv_calib3d -l-lopencv_features2d \
        -luuid
}
