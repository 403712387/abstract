#ifndef FACE_POSITION_MANAGER_H
#define FACE_POSITION_MANAGER_H
#include "Common.h"
...
class ABSTRACT_EXPORT FacePositionManager : public BaseProcess
{
    friend class FacePositionManagerAgent;
public:
    FacePositionManager(MessageRoute *messageRoute);
...
private:
    std::shared_ptr<FacePositionManagerAgent>      mAgent;
};
