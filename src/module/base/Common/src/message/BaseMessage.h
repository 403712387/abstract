...
enum MessageType
{
    ...
    FFmpeg_Ingest_Message ,         // ffmpeg拉取流
    Stop_Ingest_Message ,           // 停止拉流
    Ingest_Exception_Message ,      // 拉流异常
    Video_Frame_Message ,           // 视频帧
    Abstract_Start_Message,         // 开始提取消息
...
// 消息和消息回应的类都从此类中继承
class ABSTRACT_EXPORT BaseClass
{
public:
...
//  基础消息，不能被实例化
class ABSTRACT_EXPORT BaseMessage : public BaseClass
{
public:
...
// 基础消息的回应
class ABSTRACT_EXPORT BaseResponse : public BaseClass
{
public:
