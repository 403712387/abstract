...
private:
	...
	std::string					mConfieFileText = \
        ...
        "log4cplus.appender.ALL_MSGS.File=logs/abstract.log\n"
        ...
        "log4cplus.appender.ERROR_MSGS.File=logs/abstract.error\n"
        ...
        "log4cplus.appender.FATAL_MSGS.File=logs/abstract.fatal\n"
